...
const Student = sequelize.define('Student', {
  studentID: { type: DataTypes.STRING, primaryKey: true, allowNull: false },
  studentName: { type: DataTypes.STRING, allowNull: false },
  studentDOB: { type: DataTypes.DATE, allowNull: false },
...
const Course = sequelize.define('Course', {
  courseCode: { type: DataTypes.STRING, primaryKey: true, allowNull: false },
  courseName: { type: DataTypes.STRING, allowNull: false },
  description: { type: DataTypes.STRING, allowNull: false },
}, { freezeTableName: true });
...
const CourseRecord = sequelize.define('CourseRecord', {
  ...
  indexes: [
    { unique: true, fields: ['studentID', 'courseCode'] }
  ],
  freezeTableName: true
});
...
const School = sequelize.define('School', {
  schoolCode: { type: DataTypes.STRING, primaryKey: true, allowNull: false },
  schoolName: { type: DataTypes.STRING, allowNull: false },
  schoolPhoneNum: { type: DataTypes.STRING, allowNull: false },
  schoolDegree: { type: DataTypes.STRING, allowNull: false, unique: true },
  schoolCourses: { type: DataTypes.STRING, allowNull: false },
}, { freezeTableName: true });
...
const Employee = sequelize.define('Employee', {
  ...
  employeeSchoolCode: { type: DataTypes.STRING, allowNull: false },
  employeeName: { type: DataTypes.STRING, allowNull: false },
  employeeEmail: { type: DataTypes.STRING, allowNull: false, unique: true },
  employeePhoneNum: { type: DataTypes.STRING, allowNull: false },
  employeeAddress: { type: DataTypes.STRING, allowNull: false },
  employeeType: { type: DataTypes.ENUM('Instructor', 'AdminStaff'), allowNull: false },
}, { freezeTableName: true });

const Instructor = sequelize.define('Instructor', {}, { freezeTableName: true });
const AdminStaff = sequelize.define('AdminStaff', {}, { freezeTableName: true });
...
const Module = sequelize.define('Module', {
  ...
  timestamps: false,
  indexes: [
    { unique: true, fields: ['studentID', 'courseCode', 'year', 'instructorID'] }
  ]
});
...
(async () => {
  ...
  await UserAccount.bulkCreate([
    ...
    { userID: 'U003', userEMail: 'instructor@school.com', userRole: 'Instructor', userPassword: 'password321' },
  ]);

  await Student.bulkCreate([
    { studentID: 'S001', studentName: 'Alice', studentDOB: '2000-01-01', personalPhoneNum: '9876543210', housePhoneNum: '12345678', sex: 'F', currentAddress: '123 Main St', nationality: 'Singaporean', degree: 'BSc', gpa: 3.8, status: 'Active', studentEmail: 'alice@student.com', SchoolSchoolCode: 'SCI01', UserAccountUserID: 'U002' },
    { studentID: 'S002', studentName: 'Bob', studentDOB: '1999-03-15', personalPhoneNum: '9123456789', housePhoneNum: '87654321', sex: 'M', currentAddress: '456 Elm St', nationality: 'Singaporean', degree: 'BSc', gpa: 3.5, status: 'Active', studentEmail: 'bob@student.com', SchoolSchoolCode: 'SCI01' },
    { studentID: 'S003', studentName: 'Charlie', studentDOB: '2001-06-21', personalPhoneNum: '9988776655', housePhoneNum: '54321678', sex: 'M', currentAddress: '789 Maple Ave', nationality: 'Malaysian', degree: 'BA', gpa: 3.6, status: 'Active', studentEmail: 'charlie@student.com', SchoolSchoolCode: 'ART01' },
  ]);

  await Course.bulkCreate([
    { courseCode: 'C001', courseName: 'Physics', description: 'Introduction to Mechanics and Thermodynamics', SchoolSchoolCode: 'SCI01' },
    { courseCode: 'C002', courseName: 'Chemistry', description: 'Basics of Organic and Inorganic Chemistry', SchoolSchoolCode: 'SCI01' },
    { courseCode: 'C003', courseName: 'History', description: 'World History Overview', SchoolSchoolCode: 'ART01' },
  ]);
  ...
  await Employee.bulkCreate([
    { employeeID: 'E001', employeeSchoolCode: 'SCI01', employeeName: 'Dr. Emily Clark', employeeEmail: 'emily@school.com', employeePhoneNum: '9876543211', employeeAddress: '789 Maple Ave', employeeType: 'Instructor', UserAccountUserID: 'U003' },
    { employeeID: 'E002', employeeSchoolCode: 'ART01', employeeName: 'Mr. David Brown', employeeEmail: 'david@school.com', employeePhoneNum: '9876543212', employeeAddress: '123 Oak St', employeeType: 'AdminStaff', UserAccountUserID: 'U001' },
    { employeeID: 'E003', employeeSchoolCode: 'ENG01', employeeName: 'Ms. Sara Lee', employeeEmail: 'sara@school.com', employeePhoneNum: '9876543213', employeeAddress: '456 Pine St', employeeType: 'Instructor' },
  ]);
