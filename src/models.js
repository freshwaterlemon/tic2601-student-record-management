...
(async () => {
	...
	await School.bulkCreate([
		...
		{ schoolCode: 'BUS01', schoolName: 'Business School', schoolPhoneNum: '5566778899', schoolDegree: 'BBA', schoolCourses: 'Economics, Statistics, Management' },
		{ schoolCode: 'LAW01', schoolName: 'Law School', schoolPhoneNum: '6677889900', schoolDegree: 'LLB', schoolCourses: 'Criminal Law, Constitutional Law, Contract Law' },
	]);
	...
	await UserAccount.bulkCreate([
		...
		{ userID: 'U007', userEMail: 'frank@student.com', userRole: 'Student', userPassword: 'securepass6' },
		{ userID: 'U008', userEMail: 'grace@student.com', userRole: 'Student', userPassword: 'securepass7' },
		{ userID: 'U009', userEMail: 'henry@faculty.com', userRole: 'Faculty', userPassword: 'facultypass1' },
		{ userID: 'U010', userEMail: 'irene@faculty.com', userRole: 'Faculty', userPassword: 'facultypass2' },
	]);
	...
	await Student.bulkCreate([
		...
		{ studentID: 'S007', studentName: 'Grace', studentDOB: '2000-08-08', personalPhoneNum: '9234567890', sex: 'F', currentAddress: '404 Maple Ave', nationality: 'Thai', degree: 'BA', gpa: 3.9, status: 'Active', studentEmail: 'grace@student.com' },
		{ studentID: 'S008', studentName: 'Hank', studentDOB: '1999-11-30', personalPhoneNum: '9345678901', sex: 'M', currentAddress: '505 Walnut St', nationality: 'Vietnamese', degree: 'BBA', gpa: 3.7, status: 'Active', studentEmail: 'hank@student.com' },
	]);
	...
	await Course.bulkCreate([
		...
		{ courseCode: 'C007', courseName: 'Biology', description: 'Fundamentals of Cellular Biology' },
		{ courseCode: 'C008', courseName: 'Economics', description: 'Principles of Microeconomics and Macroeconomics' },
		{ courseCode: 'C009', courseName: 'Psychology', description: 'Introduction to Human Psychology' },
		{ courseCode: 'C010', courseName: 'Philosophy', description: 'History of Western Philosophy' },
		{ courseCode: 'C011', courseName: 'Sociology', description: 'Foundations of Social Behavior' },
		{ courseCode: 'C012', courseName: 'Art History', description: 'Art Movements and Their Impact' },
		{ courseCode: 'C013', courseName: 'Environmental Science', description: 'Study of Ecosystems and Human Impact' },
		{ courseCode: 'C014', courseName: 'Political Science', description: 'Introduction to Political Systems' },
		{ courseCode: 'C015', courseName: 'Statistics', description: 'Probability and Data Analysis' },
		{ courseCode: 'C016', courseName: 'Literature', description: 'Survey of Classic and Modern Literature' },
		{ courseCode: 'C017', courseName: 'Anthropology', description: 'Study of Human Cultures' },
		{ courseCode: 'C018', courseName: 'Geography', description: 'Physical and Human Geography' },
		{ courseCode: 'C019', courseName: 'Astronomy', description: 'Introduction to the Universe' },
		{ courseCode: 'C020', courseName: 'Music Theory', description: 'Understanding Music Composition and Harmony' },
	]);
	...
	await CourseRecord.bulkCreate([
		...
		{ studentID: 'S001', courseCode: 'C007', grade: 4.0, passfail: 'Pass', year: 2023, semester: '2' },
		{ studentID: 'S001', courseCode: 'C008', grade: 3.6, passfail: 'Pass', year: 2023, semester: '2' },
		...
		{ studentID: 'S007', courseCode: 'C005', grade: 3.9, passfail: 'Pass', year: 2023, semester: '1' },
		{ studentID: 'S007', courseCode: 'C006', grade: 4.0, passfail: 'Pass', year: 2023, semester: '2' },
		{ studentID: 'S007', courseCode: 'C016', grade: 3.8, passfail: 'Pass', year: 2024, semester: '1' },

		// Records for student S008
		{ studentID: 'S008', courseCode: 'C001', grade: 3.6, passfail: 'Pass', year: 2023, semester: '2' },
		{ studentID: 'S008', courseCode: 'C002', grade: 3.7, passfail: 'Pass', year: 2024, semester: '1' },
		{ studentID: 'S008', courseCode: 'C003', grade: 3.5, passfail: 'Pass', year: 2024, semester: '2' },
	]);
